...
ALTER TABLE BLOCKS CHANGE COLUMN block_at blocked_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP;

ALTER TABLE BLOCKS CHANGE COLUMN block_reason blocked_reason VARCHAR(255) NOT NULL;

ALTER TABLE BLOCKS CHANGE COLUMN unblock_at unblocked_at TIMESTAMP NULL;

ALTER TABLE BLOCKS CHANGE COLUMN unblock_reason unblocked_reason VARCHAR(255) NOT NULL;
